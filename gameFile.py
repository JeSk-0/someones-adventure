...
uae = pygame.image.load("UAEerror.jpg").convert()
...
pw = pygame.image.load("iderror.jpg").convert()
...
spike_img = pygame.image.load("gameAssets\spike.png").convert()
spike_img.set_colorkey((255, 255, 255))
door1 = None
vertical_momentum = 0
air_timer = 0
...
def game():
    ...
    while True:
        ...
        if player.rect.colliderect(door1):   
            ...
            if current_level == 5:
                seconds = scoreclock.tick()/1000.0
                score5 = scorecalc(seconds,13,20,star_count)
                player_prog = '5'
                UPDATE(player_prog,score5)
                level_end(score5,star_count,seconds)#game_comp()
